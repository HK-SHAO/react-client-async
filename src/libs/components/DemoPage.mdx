...
<div className="w-full text-center -mt-4 mb-10 p-0">
  <p className='m-0 p-0 text-base/snug text-gray-500 font-bold'>Easy to use async function in React components! 🚀</p>
</div>

<div className='w-full flex justify-center -mt-4'>
  <div className="place-items-center grid bg-pink-600 dark:bg-pink-800 rounded-md w-fit font-bold font-stretch-130% text-sm text-white hover:shadow-lg transition-shadow dark:hover:bg-pink-700 hover:bg-pink-500">
    <LatestVersion />
  </div>
</div>
